  ...
  <div class=" ContentDashboardUser">
    ...
    <v-row no-gutters>
      ...
      <div class="FormInscription">
          <form>
            ...
            <div  class="ZoneInput Checkboxzone">
                <input :checked='ShowInputWebsite ?  true : false' type="checkbox" class="CheckboxWebSite" @click="ShowInputWebsite ? ShowInputWebsite = false : ShowInputWebsite = true">
            ...
            <div class="ZoneInput CoverImg">
                  ...
                  <input accept=".jpg,.jpeg" type="file" hidden ref="ImgCover" @change="ImgCoverChanged()">
            ...
            <div class="ZoneInput ">
                  ...
                  <div class="LesImgs ">
                    <input  accept=".jpg,.jpeg"  type="file" hidden ref="Img1" @change="Img1Changed()">
                    <input  accept=".jpg,.jpeg"  type="file" hidden ref="Img2" @change="Img2Changed()">
                    <input  accept=".jpg,.jpeg"  type="file" hidden ref="Img3" @change="Img3Changed()">
                    <input  accept=".jpg,.jpeg"  type="file" hidden ref="Img4" @change="Img4Changed()">
      ...
      <l-map
        ...
        <button class="VldBtn" @click.prevent="UpdateUserInformationFunction()">Update</button>
          </form>
      </div>
      </v-col>
    </v-row>
...
export default {
  ...
  data: () => ({
    ...
    DunamicImgCover:'data:image/jpeg;base64,',
    DunamicImg1 :'data:image/jpeg;base64,',
    DunamicImg2:'data:image/jpeg;base64,',
    DunamicImg3:'data:image/jpeg;base64,',
    DunamicImg4:'data:image/jpeg;base64,',
    ...
    UpdateUserInformationFunction(){
      ...
      if(this.NomOrganisme__Faild !== '' && this.Email__Faild !== '' &&
          ...
          this.Img1 != ''){
            ...
            if( this.DunamicImgCover !== 'data:image/jpeg;base64,'){
            ...
            if( this.DunamicImg1 !== 'data:image/jpeg;base64,'){
            ...
            if( this.DunamicImg2 !== 'data:image/jpeg;base64,'){
            ...
            if( this.DunamicImg3 !== 'data:image/jpeg;base64,'){
            ...
            if( this.DunamicImg4 !== 'data:image/jpeg;base64,' && this.ImgCover != '' && this.$refs.Img4.files[0].size > 1000000){
              if( this.ImgCover != '' && this.$refs.Img4.files[0].size > 1000000){
                ...
                let NewImg2 =  ''
                this.DunamicImg2 === 'data:image/jpeg;base64,' ? NewImg2 = this.$refs.Img2 : NewImg2 = this.$refs.Img2.files[0]
                let NewImg3 = ''
                this.DunamicImg3 === 'data:image/jpeg;base64,' ? NewImg3= this.$refs.Img3 : NewImg3= this.$refs.Img3.files[0]
                let NewImg4 =  ''
                this.DunamicImg4 === 'data:image/jpeg;base64,' ? NewImg4 = this.$refs.Img4 : NewImg4 = this.$refs.Img4.files[0]
                    //// GET DATA
