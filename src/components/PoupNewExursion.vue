<template>
    <div class="NewPopup">
            ...
            <form>
                <div class="ZoneInput">
                    ...
                    <div class="InputFaild"  :style="SubmitInscription && NomCuruit__Faild === '' ?'border : 1px solid red ' : ''">
                        ...
                        <input type="text" placeholder="Nom de l'organisation" v-model="NomCuruit__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                ...
                <div class="ZoneInput">
                    ...
                    <div class="InputFaild"  :style="SubmitInscription && (Email__Faild === '' || EmailExist || !(/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/.test(Email__Faild))) ?'border : 1px solid red ' : ''">
                        ...
                        <input type="text" placeholder="Exempe@gmail.com" v-model="Email__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                ...
                <div class="ZoneInput Checkboxzone">
                  <input :checked='ShowInputWebsite ? true : false' :disabled="this.PropsDataFromExursion.Condition == 'Show'"  :style="ShowShopping ?  'cursor: not-allowed' : ''" type="checkbox" class="CheckboxWebSite" @click="ShowInputWebsite ? ShowInputWebsite = false : ShowInputWebsite = true">
                ...
                <div v-if="ShowInputWebsite" class="ZoneInput">
                    ...
                    <div class="InputFaild">
                        ...
                        <input type="text" placeholder="www.Website.com" v-model="WebSite__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                </div>
                <div class="ZoneInput">
                    <span>Facebook</span>
                    <div class="InputFaild">
                        ...
                        <input type="text" placeholder="www.facebook.com" v-model="Facbook__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                </div>
                <div class="ZoneInput">
                    <span>Instagram</span>
                    <div class="InputFaild">
                        ...
                        <input type="text" placeholder="www.instagram.com" v-model="Instagram__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                </div>
                <div class="ZoneInput">
                        <span>Téléphone</span>
                        <div class="InputFaild">
                            ...
                            <input type="text" placeholder="xxx xxxxxxxx" v-model="Téléphone__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                        </div>
                </div>
                <div class="ZoneInput">
                    <span>Ville ou point de départ</span>
                    <v-select
                        :items="itemsLocalisation"
                        v-model="ValueItemLocalisation"
                        :disabled="this.PropsDataFromExursion.Condition == 'Show'" 
                    ></v-select>
                </div>
                 <div class="ZoneInput">
                    <span>Ville ou point d'arrive</span>
                    <v-select
                        :items="itemsLocalisation"
                        v-model="itemsLocalisationEnd"
                        :disabled="this.PropsDataFromExursion.Condition == 'Show'" 
                    ></v-select>
                </div>
                <div class="ZoneInput">
                    ...
                    <div class="InputFaild">
                        ...
                        <input type="text" placeholder="0 DH" v-model="PriceAttractif__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                    </div>
                </div>
            <div class="ZoneInput CoverImg">
                  <span>couverture image</span>
                  <input  :disabled="this.PropsDataFromExursion.Condition == 'Show'" accept=".jpg,.jpeg" type="file" hidden ref="ImgCover" @change="ImgCoverChanged()">
                  <div class="AddImg" @click="$refs.ImgCover.click()"  :style="this.PropsDataFromExursion.Condition == 'Show' ? 'cursor: not-allowed' : ''">
            ...
            <div class="ZoneInput ">
                  ...
                  <div class="LesImgs ">
                    <input  :disabled="this.PropsDataFromExursion.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img1" @change="Img1Changed()">
                    <input  :disabled="this.PropsDataFromExursion.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img2" @change="Img2Changed()">
                    <input  :disabled="this.PropsDataFromExursion.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img3" @change="Img3Changed()">
                    <input  :disabled="this.PropsDataFromExursion.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img4" @change="Img4Changed()">
                    <div class="AddImg" @click="$refs.Img1.click()"  :style="this.PropsDataFromExursion.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img2.click()"  :style="this.PropsDataFromExursion.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img3.click()" :style="this.PropsDataFromExursion.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img4.click()" :style="this.PropsDataFromExursion.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                ...
                <div class="ZoneInput">
                    ...
                    <div class="InputFaild">
                        <textarea  @keyup="CavuleNumberChare()" placeholder="écrivez-lui votre description" v-model="Description__Faild" :disabled="this.PropsDataFromExursion.Condition == 'Show'" > </textarea>
                    </div>
                ...
                <div class="ZoneInput">
                  <div class="ZoneDate">
                            <div class="DebutDate">
                                    ...
                                    <input type="date" v-model="DateStart" :min="MinDate" @change="ChangeFinDate" :disabled="this.PropsDataFromExursion.Condition == 'Show'" >
                            </div>
                            <div class="FinDate">
                                    <span>Date de Fin</span>
                                    <input type="date" v-model="DateEnd" :min="DateStart"  :disabled="this.PropsDataFromExursion.Condition == 'Show'" >    
                            </div>
                    </div>
                </div>
...
/////////////////////////////
  ...
  methods: {
    ...
    AddNewExcursionFunction(){
      ...
      formData.append("StartCity", this.ValueItemLocalisation);
      formData.append("EndCity", this.itemsLocalisationEnd);
            ...
            if( this.DunamicImgCover !== 'data:image/jpeg;base64,'  && this.ImgCover != '' && this.$refs.ImgCover.files[0].size > 1000000){
              ...
              if( this.ImgCover != '' && this.$refs.Img4.files[0].size > 1000000){
                ...
                console.log("im her now")
                  ...
                  formData.append("EndAt",  this.DateEnd);
                  axios
                    .put(`${API_URL}/user/updateUserForm/user/${this.PropsDataFromExursion.IDRowClciked}?userID=${this.$route.params.userID}`,formData)
                    .then(() => {
                        Swal.fire({
                            position: 'top-end',
                            icon: 'success',
    ...
    GetRowDataClicked(){
      if(this.PropsDataFromExursion.Condition == "Show" || this.PropsDataFromExursion.Condition == "Update"){
        ...
        this.valueItemsOne= [],
        this.valueItemsTwo = []
        axios.get(`${API_URL}/user/getOneHotelData/${this.PropsDataFromExursion.IDRowClciked}?userID=${this.$route.params.userID}`)
        .then((response) => {
                this.NomCuruit__Faild=response.data.NomOrganisme
                ...
                this.ValueItemLocalisation = response.data.StartCity
                this.itemsLocalisationEnd = response.data.EndCity
                this.DateStart=response.data.StartAt
                this.DateEnd=response.data.EndAt
