<template>
    <div class="NewPopup">
            ...
            <div class="ZoneInput CoverImg">
                  ...
                  <input  :disabled="this.PropsDataFromBineEtre.Condition == 'Show'" accept=".jpg,.jpeg" type="file" hidden ref="ImgCover" @change="ImgCoverChanged()">
                  <div class="AddImg" @click="$refs.ImgCover.click()"  :style="this.PropsDataFromBineEtre.Condition == 'Show' ? 'cursor: not-allowed' : ''">
            ...
            <div class="ZoneInput ">
                  ...
                  <div class="LesImgs ">
                    <input  :disabled="this.PropsDataFromBineEtre.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img1" @change="Img1Changed()">
                    <input  :disabled="this.PropsDataFromBineEtre.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img2" @change="Img2Changed()">
                    <input  :disabled="this.PropsDataFromBineEtre.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img3" @change="Img3Changed()">
                    <input  :disabled="this.PropsDataFromBineEtre.Condition == 'Show'"  accept=".jpg,.jpeg"  type="file" hidden ref="Img4" @change="Img4Changed()">
                    <div class="AddImg" @click="$refs.Img1.click()"  :style="this.PropsDataFromBineEtre.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img2.click()"  :style="this.PropsDataFromBineEtre.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img3.click()" :style="this.PropsDataFromBineEtre.Condition == 'Show' ? 'cursor: not-allowed' : ''">
                    ...
                    <div class="AddImg"  @click="$refs.Img4.click()" :style="this.PropsDataFromBineEtre.Condition == 'Show' ? 'cursor: not-allowed' : ''">
...
/////Faical methode
    ...
    CheckCondition(){
        console.log(this.PropsDataFromBineEtre.Condition)
        if(this.PropsDataFromBineEtre.Condition == "New"){
            this.NewShopping = true
        }
        else if(this.PropsDataFromBineEtre.Condition == "Update")
        {            
            this.UpdateShopping = true
        }
        else if(this.PropsDataFromBineEtre.Condition == "Show"){
            this.ShowShopping = true
            console.log("show")
        }
    },
    AddNewShoppingFunction(){
      console.log(this.PropsDataFromBineEtre.IDRowClciked)
            ...
            if( this.DunamicImgCover !== 'data:image/jpeg;base64,'  && this.ImgCover != '' && this.$refs.ImgCover.files[0].size > 1000000){
              ...
              if( this.ImgCover != '' && this.$refs.Img4.files[0].size > 1000000){
                ...
                console.log("im her now")
                  ...
                  axios
                    .put(`${API_URL}/user/updateUserForm/user/${this.PropsDataFromBineEtre.IDRowClciked}?userID=${this.$route.params.userID}`,formData)
                    .then((res) => {
                        this.SpinnerWork = false
                        console.log(res)
                        Swal.fire({
    ...
    GetRowDataClicked(){
      if(this.PropsDataFromBineEtre.Condition == "Show" || this.PropsDataFromBineEtre.Condition == "Update"){
        ...
        this.valueItemsOne= [],
        this.valueItemsTwo = []
        axios.get(`${API_URL}/user/getOneHotelData/${this.PropsDataFromBineEtre.IDRowClciked}?userID=${this.$route.params.userID}`)
        .then((response) => {
